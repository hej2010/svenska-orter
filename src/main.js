...
// döp om filen till "data.xlsx" och ta bort de första 8 raderna och ta bort newlines i titeln på kolumnerna som används nedan:
...
readXlsxFile('./src/data.xlsx', { schema }).then(({ rows, errors }) => {
